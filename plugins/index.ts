...
import p_120 from '@plugins/english/dreamytranslations';
...
import p_127 from '@plugins/english/jadescrolls';
...
import p_131 from '@plugins/english/mtlreader';
...
import p_138 from '@plugins/english/novelshub';
...
import p_184 from '@plugins/portuguese/novelmania';
import p_185 from '@plugins/portuguese/tsundoku';
...
import p_190 from '@plugins/russian/MTLNovel(RU)[mtlnovel]';
import p_191 from '@plugins/russian/NovelCool(RU)[novelcool]';
import p_192 from '@plugins/russian/Ranobes(RU)[ranobes]';
import p_193 from '@plugins/russian/Rulate[rulate]';
import p_194 from '@plugins/russian/authortoday';
import p_195 from '@plugins/russian/bookriver';
import p_196 from '@plugins/russian/ficbook';
import p_197 from '@plugins/russian/jaomix';
...
import p_204 from '@plugins/russian/topliba';
import p_205 from '@plugins/russian/zelluloza';
import p_206 from '@plugins/russian/СвободныйМирРанобэ[ifreedom]';
import p_207 from '@plugins/spanish/AllNovelRead[lightnovelwp]';
import p_208 from '@plugins/spanish/AnimesHoy12[madara]';
import p_209 from '@plugins/spanish/LightNovelDaily[hotnovelpub]';
import p_210 from '@plugins/spanish/MTLNovel(ES)[mtlnovel]';
import p_211 from '@plugins/spanish/PanchoTranslations[madara]';
import p_212 from '@plugins/spanish/TC&Sega[lightnovelwp]';
import p_213 from '@plugins/spanish/TraduccionesAmistosas[madara]';
import p_214 from '@plugins/spanish/hasutl';
import p_215 from '@plugins/spanish/novelasligera';
import p_216 from '@plugins/spanish/novelawuxia';
import p_217 from '@plugins/spanish/oasistranslations';
import p_218 from '@plugins/spanish/skynovels';
...
import p_229 from '@plugins/turkish/NovelTR[lightnovelwp]';
...
import p_235 from '@plugins/turkish/epiknovel';
import p_236 from '@plugins/turkish/kakikata[madara]';
